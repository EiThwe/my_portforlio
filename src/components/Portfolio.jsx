...
const Portfolio = ({ setActiveTab }) => {
  return (
    <Waypoint onEnter={() => setActiveTab("portfolio")}>
      <section
        id="portfolio"
        className="portfolio w-full min-h-full flex justify-center items-center py-24"
      >
        <div className="w-full h-full text-white ">
          ...
          <p className="mb-10 text-[#7c7c7c] sm:text-base text-sm tracking-tighter">
            This is a collection of my recent projects.Project Title, preview
            link and the tools that have been used can be seen on hover.
          </p>
